    ...
    return (
      <div className="min-h-dvh bg-[radial-gradient(circle_at_top_left,rgba(251,191,36,0.12),transparent_28%),radial-gradient(circle_at_80%_10%,rgba(236,72,153,0.12),transparent_24%),var(--background)] p-4 lg:p-6">
        <div className="mx-auto flex min-h-[calc(100dvh-2rem)] max-w-3xl items-center justify-center">
          <div className="w-full rounded-[2rem] border border-border/70 bg-card p-8 text-center shadow-[0_24px_70px_rgba(15,23,42,0.18)]">
            <div className="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-3xl bg-success text-2xl text-success-foreground shadow-lg shadow-success/20">
              OK
            </div>
            <h2 className="[font-family:'Sora',sans-serif] text-3xl font-semibold">Conta criada</h2>
            <p className="mx-auto mt-3 max-w-xl text-sm leading-6 text-muted-foreground">
              O cadastro foi enviado com sucesso. Verifique seu email para confirmar a conta e acessar todas as jornadas do app.
            </p>
            <Link
              to="/login"
              className="mt-6 inline-flex h-12 items-center justify-center rounded-2xl bg-primary px-6 text-sm font-semibold text-primary-foreground shadow-lg shadow-primary/20"
            >
              Ir para login
            </Link>
          </div>
          ...
          <div className="rounded-[2rem] border border-border/70 bg-card/95 p-6 shadow-[0_24px_70px_rgba(15,23,42,0.18)] backdrop-blur md:p-8">
            <div className="mb-8">
              ...
              <p className="mt-2 max-w-md text-sm leading-6 text-muted-foreground">
                Crie sua conta para centralizar agenda, IA operacional e o novo modulo Conexao Gospel em uma experiencia mais elegante e objetiva.
              </p>
            </div>
            ...
            <div className="rounded-[1.5rem] border border-border/70 bg-background/75 p-5">
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-medium" htmlFor="regPhone">WhatsApp</label>
                    <input
                      id="regPhone"
                      type="tel"
                      value={phone}
